...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.search_bar.setGeometry(QtCore.QRect(260, 10, 120, 41))
        ...
        self.remove_column_button.setGeometry(QtCore.QRect(210, 10, 41, 41))
        self.remove_column_button.setObjectName("remove_column_button")
        self.reset_button = QtWidgets.QPushButton(self.centralWidget)
        self.reset_button.setGeometry(QtCore.QRect(390, 10, 41, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_column_button.setText(_translate("MainWindow", "AC"))
        self.remove_column_button.setText(_translate("MainWindow", "RC"))
